...
export function next() {
  ...
  if (appState.scene === Scene.HOME) {
    // ✅ HOME: on ne déclenche jamais l'ouverture du dialogue au scroll/enter
    // -> on va directement aux skills (le dialogue s'ouvre uniquement au clic)
    goHash("/skills");
    return;
  }
